...
# DEBUG            frame.params[0][0] = tag
    ...
    class setColor:
        ...
        def start():
            return Wye.codeFrame(testLib.setColor)
...
match frame.PC:
    ...
    case 1:
        f = testLib.clickWiggle.start()
        f.params = [frame.vars[1], frame.vars[3]]
        frame.vars[4]=[f]
        frame.SP.append(frame.vars[4][0])
        frame.PC += 1
    
    case 2:
        # pop stack and go back to do it again
        frame.SP.pop()
        frame.PC -= 1

...
class TestLib:
    ...
    class clickWiggle:
        ...
        codeDescr = (
            ...
            ("WyeCore.libs.WyeLib.waitClick",(None, "frame.params.tag")),
            ("Label", "PlayNote"),
...
frame.vars.posAngle[0] = angle
    ...
    class showFishDialog:
        ...
        codeDescr = (
            ...
            (None,
             "frame.vars.dlgButton[0] = Wye3dObjsLib._3dText(text='Set Fish and Light Angle',color=(1,1,1,1), pos=(-3,2,2), scale=(.2,.2,.2))"),
    ...
    class MyTestVerb:
        ...
        def _build(rowRef):
            ...
            return WyeCore.Utils.buildCodeText('MyTestVerb', TestLib.MyTestVerb.codeDescr, TestLib.MyTestVerb,
                                               rowRef)

...
#                    base.camera.setPos(base.camera.getPos() + fwd * (y - self.m1DownPos[1]) * self.speed + right * (x - self.m1DownPos[0]) * self.speed)
    ...
    class Dialog:
        ...
        def doSelect(frame, tag):
            ...
            # if clicked on OK or Cancel
                ...
                #print("Dialog pos", frame.vars.position, " actual pos", frame.vars.bgndGObj[0].getPos())
                # if is Cancel button
                        ...
                        if attr != "__class__":
                            ...
                            if inspect.isclass(verb):
                                if hasattr(verb, "codeDescr"):
                                    ...
                                    btnFrm.params.callback = [WyeCore.libs.WyeUI.EditLibaryVerbCallback]  # button callback
    ...
    class EditLibaryVerbCallback:
        ...
        def start(stack):
            ...
            return Wye.codeFrame(WyeUI.EditLibaryVerbCallback, stack)
        ...
        def run(frame):
            ...
            match (frame.PC):
                case 0:
                    ...
                    libFrm.params.callback = [WyeCore.libs.WyeUI.EditVarLibCallback]
                    ...
                    verbFrm.params.callback = [WyeCore.libs.WyeUI.EditVarVerbCallback]
    ...
    class EditVarLibCallback:
        ...
        def start(stack):
            #print("EditVarLibCallback started")
            return Wye.codeFrame(WyeUI.EditVarLibCallback, stack)

        def run(frame):
            match (frame.PC):
                case 0:
                    print("EditVarLibCallback data='" + str(frame.eventData) + "'")
                    data = frame.eventData
                    frame.PC += 1
                case 1:
                    pass
    ...
    class EditVarVerbCallback:
        ...
        def start(stack):
            #print("EditVarVerbCallback started")
            return Wye.codeFrame(WyeUI.EditVarVerbCallback, stack)

        def run(frame):
            match (frame.PC):
                case 0:
                    print("EditVarVerbCallback data='" + str(frame.eventData) + "'")
                    data = frame.eventData
                    frame.PC += 1
                case 1:
                    pass
            ...
            match (frame.PC):
                ...
                case 1:
                    ...
                    if dlgFrm.params.retVal[0] == Wye.status.SUCCESS:
                        ...
                        rowTxt = "  " + label + " type:" + Wye.dType.tostring(wType) + " = " + str(initVal)
                        #print("new row", rowTxt)
                        btnFrm.verb.setLabel(btnFrm, rowTxt)

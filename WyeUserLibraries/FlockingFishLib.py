...
class FlockingFishLib:
  def _build():
    WyeCore.Utils.buildLib(FlockingFishLib)
  canSave = True  # all verbs can be saved with the library
  modified = False  # no changes
  class FlockingFishLib_rt:
   pass #1
  ...
  class fish2:
    ...
    def _build(rowRef):
        # print("Build ",fish2)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('fish2', FlockingFishLib.fish2.codeDescr, FlockingFishLib.fish2, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FlockingFishLib.fish2, stack)

    def run(frame):
        # print('Run 'fish2)
        FlockingFishLib.FlockingFishLib_rt.fish2_run_rt(frame)
  ...
  class fish3:
    ...
    def _build(rowRef):
        # print("Build ",fish3)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('fish3', FlockingFishLib.fish3.codeDescr, FlockingFishLib.fish3, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FlockingFishLib.fish3, stack)

    def run(frame):
        # print('Run 'fish3)
        FlockingFishLib.FlockingFishLib_rt.fish3_run_rt(frame)
  ...
  class followFish:
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('followFish', FlockingFishLib.followFish.codeDescr, FlockingFishLib.followFish, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FlockingFishLib.followFish, stack)

    def run(frame):
        # print('Run 'followFish)
        FlockingFishLib.FlockingFishLib_rt.followFish_run_rt(frame)
  ...
  class followFish2:
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('followFish2', FlockingFishLib.followFish2.codeDescr, FlockingFishLib.followFish2, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FlockingFishLib.followFish2, stack)

    def run(frame):
        # print('Run 'followFish2)
        FlockingFishLib.FlockingFishLib_rt.followFish2_run_rt(frame)
  ...
  class followFish3:
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('followFish3', FlockingFishLib.followFish3.codeDescr, FlockingFishLib.followFish3, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FlockingFishLib.followFish3, stack)

    def run(frame):
        # print('Run 'followFish3)
        FlockingFishLib.FlockingFishLib_rt.followFish3_run_rt(frame)
  ...
  class leaderFish2:
    ...
    paramDescr =  ()
    varDescr =  (
        ("tgtPos",Wye.dType.FLOAT_LIST,[15.0, 40.0, 0.0]),
...
'''),
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildParallelText('FlockingFishLib', 'leaderFish2', FlockingFishLib.leaderFish2.codeDescr, FlockingFishLib.leaderFish2)

    def start(stack):
        return FlockingFishLib.FlockingFishLib_rt.leaderFish2_start_rt(stack)
...
'''),
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildParallelText('FlockingFishLib', 'leaderFish3', FlockingFishLib.leaderFish3.codeDescr, FlockingFishLib.leaderFish3)

    def start(stack):
        return FlockingFishLib.FlockingFishLib_rt.leaderFish3_start_rt(stack)

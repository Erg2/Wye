...
class FunFishLib:
  ...
  class Jelly1:
    ...
    def _build(rowRef):
        # print("Build ",Jelly1)
        rowIxRef = [0]
        return WyeCore.Utils.buildParallelText('FunFishLib', 'Jelly1', FunFishLib.Jelly1.codeDescr, FunFishLib.Jelly1)

    def start(stack):
        return FunFishLib.FunFishLib_rt.Jelly1_start_rt(stack)

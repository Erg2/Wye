...
class FishLib:
  def _build():
    WyeCore.Utils.buildLib(FishLib)
  ...
  class JellyFish:
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildParallelText('FishLib', 'JellyFish', FishLib.JellyFish.codeDescr, FishLib.JellyFish)

    def start(stack):
        return FishLib.FishLib_rt.JellyFish_start_rt(stack)
  ...
  class flashingFish:
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('flashingFish', FishLib.flashingFish.codeDescr, FishLib.flashingFish, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FishLib.flashingFish, stack)

    def run(frame):
        # print('Run 'flashingFish)
        FishLib.FishLib_rt.flashingFish_run_rt(frame)
  ...
  class flockingFish1:
    ...
    def _build(rowRef):
        # print("Build ",flockingFish1)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('flockingFish1', FishLib.flockingFish1.codeDescr, FishLib.flockingFish1, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FishLib.flockingFish1, stack)

    def run(frame):
        # print('Run 'flockingFish1)
        FishLib.FishLib_rt.flockingFish1_run_rt(frame)
  ...
  class flockingFish2:
    ...
    def _build(rowRef):
        # print("Build ",flockingFish2)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('flockingFish2', FishLib.flockingFish2.codeDescr, FishLib.flockingFish2, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FishLib.flockingFish2, stack)

    def run(frame):
        # print('Run 'flockingFish2)
        FishLib.FishLib_rt.flockingFish2_run_rt(frame)
  ...
  class flockingFish3:
    ...
    def _build(rowRef):
        # print("Build ",flockingFish3)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('flockingFish3', FishLib.flockingFish3.codeDescr, FishLib.flockingFish3, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FishLib.flockingFish3, stack)

    def run(frame):
        # print('Run 'flockingFish3)
        FishLib.FishLib_rt.flockingFish3_run_rt(frame)
  ...
  class flyingFish:
    ...
    def _build(rowRef):
        # print("Build ",flyingFish)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('flyingFish', FishLib.flyingFish.codeDescr, FishLib.flyingFish, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FishLib.flyingFish, stack)

    def run(frame):
        # print('Run 'flyingFish)
        FishLib.FishLib_rt.flyingFish_run_rt(frame)
  ...
  class smallFish:
    ...
    def _build(rowRef):
        # print("Build ",smallFish)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('smallFish', FishLib.smallFish.codeDescr, FishLib.smallFish, rowIxRef)

    def start(stack):
        return Wye.codeFrame(FishLib.smallFish, stack)

    def run(frame):
        # print('Run 'smallFish)
        FishLib.FishLib_rt.smallFish_run_rt(frame)

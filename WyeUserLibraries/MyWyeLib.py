...
class MyWyeLib:
  ...
  class fish2:
    ...
    def _build(rowRef):
        # print("Build ",fish2)
        rowIxRef = [0]
        return WyeCore.Utils.buildCodeText('fish2', MyWyeLib.fish2.codeDescr, MyWyeLib.fish2, rowIxRef)

    def start(stack):
        return Wye.codeFrame(MyWyeLib.fish2, stack)

    def run(frame):
        # print('Run 'fish2)
        MyWyeLib.MyWyeLib_rt.fish2_run_rt(frame)
...
'''),
    ...
    def _build(rowRef):
        ...
        rowIxRef = [0]
        return WyeCore.Utils.buildParallelText('MyWyeLib', 'leaderFish2', MyWyeLib.leaderFish2.codeDescr, MyWyeLib.leaderFish2)

    def start(stack):
        return MyWyeLib.MyWyeLib_rt.leaderFish2_start_rt(stack)

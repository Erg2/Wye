...
'''),
    ...
    def build():
        ...
        return WyeCore.Utils.buildParallelText('MyWyeLib','leaderFish', MyWyeLib.leaderFish.codeDescr, MyWyeLib.leaderFish)

    def start(stack):
        return MyWyeLib.MyWyeLib_rt.leaderFish_start_rt(stack)
    ...
    def run(frame):
        ...
        try:
          ...
          if not hasattr(frame, 'errOnce'):
            print('MyWyeLib leaderFish runParallel failed\n', str(e))
            import traceback
